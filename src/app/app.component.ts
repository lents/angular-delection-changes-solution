...
export class AppComponent implements OnInit {
  salesList = List<EmployeeData>(Sales);
  rndList = List<EmployeeData>(Rnd);
  label = '';

  constructor(private generator: ListGenerator, private ngZone: NgZone) {}
  ...
  ngOnInit() {
    ...
    this.salesList.concat(this.rndList).forEach((employee: EmployeeData) => {
